...
public class CoreCacheDataServiceImpl implements CoreCacheDataService {
	...
	@SuppressWarnings("unchecked")
	@Override
	public Page<CoreCacheData> findCoreCacheDataPage(String crcdaName, String crcdaValue, int pageNum, int pageSize) {
		Map<String, Object> hashMap = new HashMap<String, Object>();
		hashMap.put("crcdaName", crcdaName);
		hashMap.put("crcdaValue", crcdaValue);

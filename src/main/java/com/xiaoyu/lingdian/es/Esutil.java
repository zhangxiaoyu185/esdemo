package com.xiaoyu.lingdian.es;
...
public class Esutil {
	public static Client client = null;
		...
		public static  Client getClient() {
			...
			Settings settings = Settings.settingsBuilder().put("cluster.name", "esdemo").build();
			try {
...
//						.addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("slave2"), 9300));
	...
	public static String addIndex(String index,String type,CoreCacheData Doc){
		HashMap<String, Object> hashMap = new HashMap<String, Object>();
		hashMap.put("id", Doc.getCrcdaUnid());
		hashMap.put("uuid", Doc.getCrcdaUuid());
		hashMap.put("name", Doc.getCrcdaName());
		hashMap.put("value", Doc.getCrcdaValue());
	...
	public static Map<String, Object> search(String key,String index,String type,int start,int row){
		...
		builder.addHighlightedField("value");
		//设置高亮前缀
...
//			builder.setQuery(QueryBuilders.termQuery("title",key));
			builder.setQuery(QueryBuilders.multiMatchQuery(key, "name","value"));
		}
		...
		for (SearchHit searchHit : hits2) {
			...
			HighlightField highlightField2 = highlightFields.get("value");
